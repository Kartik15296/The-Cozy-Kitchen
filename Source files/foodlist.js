...
function storeText(Id) {
    ...
    console.log(Id);
    window.location.href = './Source files/fooditem.html';
}


document.addEventListener("DOMContentLoaded", function () {
    const fooditems = document.querySelector(".card-grp")

    const showfood = food_list.map((item) => {
        return `
       <div class="card card-style " onclick="storeText(${item._id})">
